...
const CONTROL_CLASS =
  'flex size-11 items-center justify-center rounded-sm border border-panel-border bg-panel/90 backdrop-blur-md transition-colors hover:bg-foreground/5 focus-ring md:size-9'
